    ...
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            <Navigate
              to={ROLE_HOME[user.role] || '/admin/dashboard'}
              replace
            />
          ) : (
            <LoginPage />
      ...
      <Route
        ...
        element={
          <Navigate
            to={
              user
                ? ROLE_HOME[user.role] || '/admin/dashboard'
                : '/login'
            }
            replace
          />
      ...
      <Route
        path="/admin/calendar"
        element={
          <P roles={['superadmin', 'admin', 'trainer', 'trainee']}>
      ...
      <Route
        path="/sessions/classroom/new"
        element={
          <P roles={['superadmin', 'admin', 'trainer']}>
      ...
      <Route
        path="/trainee/my-training"
        element={
          <P roles={['trainee']}>
            <MyTrainingHistoryPage />
          </P>
        }
      />
